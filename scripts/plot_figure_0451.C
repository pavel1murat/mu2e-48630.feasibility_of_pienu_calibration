//-----------------------------------------------------------------------------
// PTRK
// BPIP4B0 YIELDS: ST vs degrader
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0451(int Figure, int Print) {
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip4b0s51,ana_job,"PipenuAna","trk_150/p_2");
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bpip4b0s54,ana_job,"PipenuAna","trk_150/p_2");
  p.hd[1].fRebin       = 2;
  ...
  p.hd[1].fLumiSF      = gPipenu->GetChannel("bpip4b0s51r0100")->NormSF();
