//-----------------------------------------------------------------------------
// CHI2D for BPIP2, track ID, stops in the ST vs stops in the degrader
// normalization ?
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0204(int Figure, int Print) {
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip2b0s51,ana_job,"PipenuAna","trk_100/chi2d");
  p.hd[0].fRebin       = 1;
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bpip2b0s54,ana_job,"PipenuAna","trk_100/chi2d");
  p.hd[1].fRebin       = 1;
