//-----------------------------------------------------------------------------
// tight ID, no DEG: trk_178/p_2 for STT, DEG and DIF
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0032(int Figure, int Print) {
    
  const char* bpip0b0s51  = "pipenu.bpip0b0s51r0100";
  const char* bpip0b0s54  = "pipenu.bpip0b0s54r0100";
  const char* bmup0b0s54  = "pipenu.bmup0b0s54r0100";
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,book,bpip0b0s51,ana_job,ana_module,hist_name);
...
//-----------------------------------------------------------------------------
  p.hd[1]              = hist_data_t(catalog,book,bmup0b0s54,ana_job,ana_module,"trk_128/p_2");
  p.hd[1].fRebin       = 5;
  p.hd[1].fLabel       = "DIF";
