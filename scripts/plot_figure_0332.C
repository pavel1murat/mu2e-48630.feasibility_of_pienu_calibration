//-----------------------------------------------------------------------------
// tight ID, 3mm DEG: trk_178/p_2 for STT, DEG and DIF
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0332(int Figure, int Print) {
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,book,bpip3b0s51,ana_job,ana_module,hist_name);
  ...
  p.hd[1]              = hist_data_t(catalog,book,bpip3b0s54,ana_job,ana_module,hist_name);
  p.hd[1].fRebin       = 5;
...
//-----------------------------------------------------------------------------
  p.hd[2]              = hist_data_t(catalog,book,bmup3b0s54,ana_job,ana_module,"trk_128/p_2");
  p.hd[2].fRebin       = 5;
  p.hd[2].fLabel       = "DIF";
