...
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_2402(int Figure, int Print) {
    
  const char* bpip2b0s24  = "pipenu.bpip2b0s24r0000";
  const char* bpip3b0s24  = "pipenu.bpip3b0s24r0000";
  const char* bpip4b0s24  = "pipenu.bpip4b0s24r0000";
  const char* bpip5b0s24  = "pipenu.bpip5b0s24r0000";
