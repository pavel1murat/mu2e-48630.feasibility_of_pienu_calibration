//-----------------------------------------------------------------------------
// track ID: bpip2b0 : nactive_1
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0274(int Figure, int Print) {
    
  const char* bpip2b0s51  = "pipenu.bpip2b0s51r0100"; // STT
  const char* bpip2b0s54  = "pipenu.bpip2b0s54r0100"; // DEG
...
//------------------------------------------------------------------------------
  ...
  p.hd[1].fRebin       = 1;
  p.hd[1].fLabel       = "pion stops in degrader";
  ...
  p.fLegendXMin  = 0.35; p.fLegendXMax  = 0.65; p.fLegendYMin  = 0.70; p.fLegendYMax  = 0.80; 
  ...
  TArrow* arr = new TArrow(25,800,25,100,0.015);
  arr->SetLineWidth(2);
  arr->Draw();
