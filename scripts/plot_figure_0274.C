...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip2b0s51,ana_job,"PipenuAna","tid_0/nactive_1");
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bmup2b0s54,ana_job,"PipenuAna","tid_0/nactive_1");
  p.hd[1].fRebin       = 2;
  p.hd[1].fLabel       = "DIF";
