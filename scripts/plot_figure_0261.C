//-----------------------------------------------------------------------------
// ST vs degrader yields for bpip2b0 - tracks with fIDWord[0] = 0 : trk_151/p_2
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0261(int Figure, int Print) {
  ...
  const char* hist_name   = "trk_151/p_2";
