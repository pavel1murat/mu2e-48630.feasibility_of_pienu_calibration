...
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0232(int Figure, int Print) {
...
//-----------------------------------------------------------------------------
  p.hd[2]              = hist_data_t(catalog,book,bmup2b0s54,ana_job,ana_module,"trk_128/p_2");
  p.hd[2].fRebin       = 5;
  p.hd[2].fLabel       = "DIF";
  ...
  p.hd[2].fLumiSF      = gPipenu->GetChannel("bmup2b0s54r0100")->NormSF();
