//-----------------------------------------------------------------------------
// BPIP5: track ID, stops in the ST vs stops in the degrader
// normalization ?
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0503(int Figure, int Print) {
    
  const char* bpip2b0s51  = "pipenu.bpip5b0s51r0100";
  const char* bpip2b0s54  = "pipenu.bpip5b0s54r0100";
...
//------------------------------------------------------------------------------
  ...
  p.fLabel             = "#pi^{+} #rightarrow e^{+}#nu, 5 mm Ti degrader, all reconstructed tracks";
