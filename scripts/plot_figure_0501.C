...
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0501(int Figure, int Print) {
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip5b0s51,ana_job,"PipenuAna","trk_150/p_2");
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bpip5b0s54,ana_job,"PipenuAna","trk_150/p_2");
  p.hd[1].fRebin       = 1;
  p.hd[1].fXAxisTitle  = "T0, ns";
  p.hd[1].fXMin        = -10.;
  p.hd[1].fXMax        = 10.;
  p.hd[1].fLabel       = "Degrader (2 mm Ti) ";
  p.hd[1].fYLogScale   = 0;
  ...
  p.hd[2]              = hist_data_t(catalog,"pipenu",bmup5b0s54,ana_job,"PipenuAna","trk_150/p_2");
  p.hd[2].fRebin       = 1;
