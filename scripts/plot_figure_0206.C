...
// normalization ?
//-----------------------------------------------------------------------------
plot_data_t* plot_figure_0206(int Figure, int Print) {
...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip2b0s51,ana_job,"PipenuAna","trk_100/momerr");
  p.hd[0].fRebin       = 1;
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bpip2b0s54,ana_job,"PipenuAna","trk_100/momerr");
  p.hd[1].fRebin       = 1;
  ...
  p.fXAxisTitle        = "#sigma(P), MeV/c";
  // p.fYLogScale        = 1;

  p.fStatBoxYMax = 0.90;
  p.fStatBoxYMin = 0.75;

  p.fLegendXMin  = 0.40; p.fLegendXMax  = 0.7; p.fLegendYMin  = 0.72; p.fLegendYMax  = 0.8; 
  ...
  TArrow* arr = new TArrow(0.5,600,0.5,100,0.015);
  arr->Draw();
