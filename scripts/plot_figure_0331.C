...
// 1.23e-4 : BR(pi --> e nu)
//------------------------------------------------------------------------------
  p.hd[0]              = hist_data_t(catalog,"pipenu",bpip3b0s51,ana_job,ana_module,hist_name);
  ...
  p.hd[1]              = hist_data_t(catalog,"pipenu",bpip3b0s54,ana_job,ana_module,hist_name);
  p.hd[1].fRebin       = 5;
...
//-----------------------------------------------------------------------------
  p.hd[2]              = hist_data_t(catalog,"pipenu",bmup3b0s54,ana_job,ana_module,"trk_108/p_2");
  p.hd[2].fRebin       = 5;
  p.hd[2].fLabel       = "DIF";
